...
namespace SEP_Demo.Tests.Sprint02UnitTest
{
    ...
    public class CreataProductUnitTest
    {
        ...
        public void CreateProduct_Success()
        {
            ...
            serverMock.Setup(x => x.MapPath("~/Chạy ngay đi/")).Returns(@"C:\Users\HP\Desktop\Chạy ngay đi\");
            ...
            file1Mock.Setup(x => x.FileName).Returns("69.jpg");
            ...
            // assert
            file1Mock.Verify(x => x.SaveAs(@"Chạy ngay đi\69.jpg"));
